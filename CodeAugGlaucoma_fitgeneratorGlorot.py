...
def Model_func(input_shape):
    ...
    X = Conv2D(64, (3, 3), strides = (1, 1), name = 'conv1a', kernel_initializer="glorot_uniform")(X)
    X = BatchNormalization(axis = 3, name = 'bn1a')(X)
    X = Activation('relu')(X)
 
    X = ZeroPadding2D((1, 1))(X)
    X = Conv2D(64, (3, 3), strides = (1, 1), name = 'conv1b', kernel_initializer="glorot_uniform")(X)
    ...
    X = ZeroPadding2D((1, 1))(X)
    X = Conv2D(128, (3, 3), strides = (1, 1), name = 'conv2a', kernel_initializer="glorot_uniform")(X)
    X = BatchNormalization(axis = 3, name = 'bn2a')(X)
    X = Activation('relu')(X)
 
    X = ZeroPadding2D((1, 1))(X)
    X = Conv2D(128, (3, 3), strides = (1, 1), name = 'conv2b', kernel_initializer="glorot_uniform")(X)
    ...
    X = ZeroPadding2D((1, 1))(X)
    X = Conv2D(256, (3, 3), strides = (1, 1), name = 'conv3a', kernel_initializer="glorot_uniform")(X)
    X = BatchNormalization(axis = 3, name = 'bn3a')(X)
    X = Activation('relu')(X)
 
    X = ZeroPadding2D((1, 1))(X)
    X = Conv2D(256, (3, 3), strides = (1, 1), name = 'conv3b', kernel_initializer="glorot_uniform")(X)
    X = BatchNormalization(axis = 3, name = 'bn3b')(X)
    X = Activation('relu')(X)  
 
    X = ZeroPadding2D((1, 1))(X)
    X = Conv2D(256, (3, 3), strides = (1, 1), name = 'conv3c', kernel_initializer="glorot_uniform")(X)
    ...
    X = Dense(100, activation='relu', name='fc1', kernel_initializer="glorot_uniform")(X)
    X = Dense(10, activation='relu', name='fc2', kernel_initializer="glorot_uniform")(X)
    X = Dense(2, activation='softmax', name='sm', kernel_initializer="glorot_uniform")(X)
